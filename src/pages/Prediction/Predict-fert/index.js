...
export const PredictFert = () => {
  ...
  const handleClick = () => {
    ...
    axios({
      ...
      method: "POST",
      // duong link api
      url: "https://lobster-app-rken7.ondigitalocean.app/predict_fertilizer",
      // data
      data: request,
      // nhieu du lieu
                ...
                <Table className={classes.table} aria-label="simple table">
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell align="center">
                        {predictionData.svm_model_prediction} (
                        {predictionData.svm_model_probability}%)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
      ...
      <div className="main">
        ...
        <div className="form">
          <div className="form__form_group">
            ...
            <center>
              <div className="form__title">Đề xuất phân bón cho đất</div>
            </center>
