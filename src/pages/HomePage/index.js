      ...
      <div>
        <section className='section-banner'>
          <div className='container'>
            <div className='banner__box'>
              ...
              {currentUser ? "" : <div className='banner__box__btn'>
                <span className="banner__btn" onClick={handleOpenModal}>BẮT ĐẦU</span>
              </div>}
        ...
        <div className='section-intro'>
          <div className='intro__title'>
            <h2>"Nếu ai cũng có thể trồng một cái cây trong cuộc đời
              thì nỗi cô đơn chỉ còn là đứa trẻ của niềm vui"</h2>
